        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'This escapement record will be permanently removed from the cabinet. This cannot be undone.',
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (index >= projectProv.entries.length) {
      return Scaffold(
        ...
        body: const Center(child: Text('Mechanism not found.')),
      );
    }
    ...
    final gdcColor = getRateDetectionColor(entry.rateDetectionClass);
    final condColor = getConditionColor(entry.preservationStatus);
    final hazard = isHazardMechanism(entry.preservationStatus, entry.rateDetectionClass);
              ...
              child: Center(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: kPanelBg.withValues(alpha: 0.94),
                      border: Border.all(color: kOutline),
                    ),
                    child: Icon(Icons.arrow_back_rounded, color: kAccent, size: 20.sp),
                  ),
                ),
              ),
            ),
            actions: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.delete_outline_rounded, color: kError, size: 20.sp),
                ),
              ),
              SizedBox(width: 8.w),
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.edit_rounded, color: kAccent, size: 18.sp),
                ),
              ),
              SizedBox(width: 16.w),
            ],
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  entry.rateDetectionClass.label.toUpperCase(),
                                  style: GoogleFonts.ibmPlexMono(
                                    color: gdcColor,
                                    fontSize: 10.sp,
                                    fontWeight: FontWeight.w700,
                    ...
                    _buildSpecRow('Pallet Material', entry.bodyMetal.label),
                    _buildSpecRow('Regulating Action', entry.lockingMechanismType.label),
                    _buildSpecRow('Escape Wheel Tooth Count', entry.airInflowDesign),
                    ...
                    if (entry.inspectorAndCollieryStamps.isNotEmpty) ...[
                      SizedBox(height: 28.h),
                      _buildSectionHeader('CALIBRATED MILL / KILN'),
                    ...
                    if (entry.accompanyingGear.isNotEmpty) ...[
                      SizedBox(height: 28.h),
                      _buildSectionHeader('TEMPERATURE RANGE'),
                      SizedBox(height: 12.h),

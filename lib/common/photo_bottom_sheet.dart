            ...
            Row(
              children: [
                Container(
                  ...
                  child: CustomPaint(
                    painter: _SheetMechanismPainter(),
                  ),
                ),
                SizedBox(width: 14.w),
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2.h),
                    Text(
                      'Add a visual record to this mechanism entry',
...
// ── Miniature gauze mechanism icon for the sheet header ────────────────────────────
class _SheetMechanismPainter extends CustomPainter {
  @override
  ...
  @override
  bool shouldRepaint(covariant _SheetMechanismPainter old) => false;
}
